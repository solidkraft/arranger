...
RSpec.describe Event do
  context "initialization" do
    context "when location and/or starting date/time is not provided" do
      it 'defaults to blank as value' do
        event = Event.new(location: nil, starts_at: nil, organizer: nil, invitee: nil)
  ...
  describe "#schedule" do
    it "schedules event" do
      location, starts_at, organizer, invitee = "Somewhere", "One day", "Host", "Invitee"
      event = Event.new(location: location, starts_at: starts_at, organizer: organizer, invitee: invitee)
